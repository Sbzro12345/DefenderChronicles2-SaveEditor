...
# the Elwyn identifier: [01 00 00 00 FF FF FF FF][149 bytes][9 maps x 8 bytes]
...
def main_menu(profile, baseline, bundle, state, commit):
    ...
    while True:
        ...
        # Aggregate unsaved changes for all heroes for the top-level menu
        ...
        if choice == 1:
            ...
            all_offsets = [token_offset] + gen_map_offsets + mel_map_offsets + all_hero_offsets
